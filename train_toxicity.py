...
train_toxicity.py
-----------------
Train a Random Forest classifier to predict compound toxicity to humans.

Usage:
    python train_toxicity.py --features datasets/features.csv --model-output models/toxicity.pkl
"""
...
def main():
    parser = build_cli("Toxicity", "Toxicity_Label")
    args = parser.parse_args()

    print("=" * 60)
    print("  Random Forest – Toxicity Prediction")
    print("=" * 60)
